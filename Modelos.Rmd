...
# Aahora simplemente puedo cargarlos sin necesidad de descarga
...
```{r}
# Construyo el modelo
bc.model <- bioclim(x = predictors2, p = coords)
```
...
# Calidad del modelo
# Crossvalidation: 
# Mirar el punto 2.2: https://damariszurell.github.io/HU-GCIB/4_SDM_eval.html#22_assessing_sdm_performance
...
group <- kfold(backgr, 5) #Hago 5 grupos de esos puntos
...
saveRDS(predict.presence.bc.bioclim, "BIOCLIM/Predicciones_BIOCLIM.rds")
```
